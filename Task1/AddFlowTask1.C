AliAnalysisFlowTask1* AddFlowTask1(TString name = "FlowTask", TString weightsFile = "", const char* suffix = "")
{
    ...
    AliAnalysisFlowTask1* task = new AliAnalysisFlowTask1(taskName.Data(), useWeights);
    if(!task) return 0x0;
