...
void runFlowTask1()
{
...
#if !defined (__CINT__) || defined (__CLING__)
    gInterpreter->LoadMacro("AliAnalysisFlowTask1.cxx++g");
    AliAnalysisFlowTask1 *task = reinterpret_cast<AliAnalysisFlowTask1*>(gInterpreter->ExecuteMacro("AddFlowTask1.C(\"FlowTask\", \"/Users/tomasfernandezbouvier/Desktop/Thesis-training-/Weights/weight.root\")"));
    //!AliAnalysisFlowTask1 *task = reinterpret_cast<AliAnalysisFlowTask1*>(gInterpreter->ExecuteMacro("AddFlowTask1.C(\"FlowTask\", \"alien:///alice/cern.ch/user/f/fernandt/weight.root\")"));

#else
    gROOT->LoadMacro("AliAnalysisFlowTask1.cxx++g");
    gROOT->LoadMacro("AddFlowTask1.C");
    AliAnalysisFlowTask1 *task = AddFlowTask1();
#endif
    ...
    if(local) {
        ...
        alienHandler->SetAdditionalLibs("AliAnalysisFlowTask1.cxx AliAnalysisFlowTask1.h");
        // alienHandler->SetAdditionalLibs("PWGCFFLOWGF.par libPWGEMCALbase.so");
        alienHandler->SetAnalysisSource("AliAnalysisFlowTask1.cxx");
        ...
        alienHandler->SetGridWorkingDir("Task1_v2_no_gap_no_weights");
        alienHandler->SetGridOutputDir("Task1OutputDir_v2_no_gap_no_weights");
