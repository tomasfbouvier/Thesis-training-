AliAnalysisFlowTask2* AddFlowTask2(TString name = "FlowTask", TString weightsFile = "", const char* suffix = "")
{
    ...
    AliAnalysisFlowTask2* task = new AliAnalysisFlowTask2(taskName.Data(), useWeights);
    if(!task) return 0x0;
