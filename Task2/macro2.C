...
TProfile* rebin(TProfile *profile){
...
void macro2(){
    ...
    //!prof_2pc->SetBins(10, bin_edges , 13, bin_edges_y);
    
//!project->SetBins(70, 0.2, 5.);
    
    TCanvas *c2 = new TCanvas("c2","multigraph",200, 10,700,500);
    
    TProfile *profiley= prof_2pc->ProfileY("ad",4,5);
    TProfile *profiley2= (TProfile*) profiley->Rebin(13, "profiley2", bin_edges_y );
    profiley2->Draw();
