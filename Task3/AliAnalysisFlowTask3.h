...
class AliAnalysisFlowTask3 : public AliAnalysisTaskSE
{
    ...
    private:
        ...
        TProfile*               fMyProfile_v_2_2;     //! is this correct?
        TProfile*               fMyProfile_v_2_2_Neg;     //! is this correct?
        TProfile*               fMyProfile_v_2_4;     //! is this correct?
        TProfile*               fMyProfile_v_2_6;     //! is this correct?
        TProfile*               fMyProfile_v_2_8;     //! is this correct?
        ...
        TProfile*             fProfiles_collection2[10];     //! is this correct?
        TProfile*             fProfiles_collection4[10];     //! is this correct?        TProfile2D*             fProfiles_collection2[10];     //! is this correct?
        TProfile*             fProfiles_collection6[10];     //! is this correct?        TProfile2D*             fProfiles_collection2[10];     //! is this correct?
        TProfile*             fProfiles_collection8[10];     //! is this correct?
        ...
        void Calculate_correlation_2();
        void Calculate_correlation_4();
        void Calculate_correlation_6();
        void Calculate_correlation_8();
