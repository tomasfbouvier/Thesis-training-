...
void runFlowTask3()
{
...
#if !defined (__CINT__) || defined (__CLING__)
    gInterpreter->LoadMacro("AliAnalysisFlowTask3.cxx++g");
    AliAnalysisFlowTask3 *task = reinterpret_cast<AliAnalysisFlowTask3*>(gInterpreter->ExecuteMacro("AddFlowTask3.C(\"FlowTask\", \"/Users/tomasfernandezbouvier/Desktop/Thesis-training-/Weights/weight.root\")"));
    //!AliAnalysisFlowTask3 *task = reinterpret_cast<AliAnalysisFlowTask3*>(gInterpreter->ExecuteMacro("AddFlowTask3.C(\"FlowTask\", \"alien:///alice/cern.ch/user/f/fernandt/weight.root\")"));

#else
    gROOT->LoadMacro("AliAnalysisFlowTask3.cxx++g");
    gROOT->LoadMacro("AddFlowTask3.C");
    AliAnalysisFlowTask3 *task = AddFlowTask3();
#endif
    ...
    if(local) {
        ...
        alienHandler->SetAdditionalLibs("AliAnalysisFlowTask3.cxx AliAnalysisFlowTask3.h");
        // alienHandler->SetAdditionalLibs("PWGCFFLOWGF.par libPWGEMCALbase.so");
        alienHandler->SetAnalysisSource("AliAnalysisFlowTask3.cxx");
