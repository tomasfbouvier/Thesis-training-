AliAnalysisFlowTask3* AddFlowTask3(TString name = "FlowTask", TString weightsFile = "", const char* suffix = "")
{
    ...
    AliAnalysisFlowTask3* task = new AliAnalysisFlowTask3(taskName.Data(), useWeights);
    if(!task) return 0x0;
