AliAnalysisFlowTask5* AddFlowTask5(TString name = "FlowTask", TString weightsFile = "", const char* suffix = "")
{
    ...
    AliAnalysisFlowTask5* task = new AliAnalysisFlowTask5(taskName.Data(), useWeights);
    if(!task) return 0x0;
