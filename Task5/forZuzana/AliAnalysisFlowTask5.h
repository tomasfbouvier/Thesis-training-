...
class AliAnalysisFlowTask5 : public AliAnalysisTaskSE
{
    ...
    private:
        ...
        TProfile*               fProfile_SC_5_2; //!
        TProfile*               fProfile_SC_5_3; //!
        TProfile*               fProfile_SC_4_3; //!
        TProfile*               fProfile_SC_4_2; //!
        TProfile*               fProfile_SC_3_2; //!
    
        TProfile*               fProfile_2pc_2; //!
        TProfile*               fProfile_2pc_3; //!
        TProfile*               fProfile_2pc_4; //!
        TProfile*               fProfile_2pc_5; //!
    
        TProfile*             fProfiles_collection_SC_5_2[10];     //!
        TProfile*             fProfiles_collection_SC_5_3[10];     //!
        TProfile*             fProfiles_collection_SC_4_3[10];     //!
        TProfile*             fProfiles_collection_SC_4_2[10];     //!
        TProfile*             fProfiles_collection_SC_3_2[10];     //!
    
        TProfile*             fProfiles_collection_2pc_2[10]; //!
        TProfile*             fProfiles_collection_2pc_3[10]; //!
        TProfile*             fProfiles_collection_2pc_4[10]; //!
        TProfile*             fProfiles_collection_2pc_5[10]; //!
        ...
        void Calculate_correlation_2(TProfile* filling_prof, TProfile*  filling_collect[]);
        void Calculate_correlation_4(TProfile* filling_prof, TProfile*  filling_collect[]);
