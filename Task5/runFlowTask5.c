...
void runFlowTask5()
{
...
#if !defined (__CINT__) || defined (__CLING__)
    gInterpreter->LoadMacro("AliAnalysisFlowTask5.cxx++g");
    AliAnalysisFlowTask5 *task = reinterpret_cast<AliAnalysisFlowTask5*>(gInterpreter->ExecuteMacro("AddFlowTask5.C(\"FlowTask\", \"/Users/tomasfernandezbouvier/Desktop/Thesis-training-/Weights/weight.root\")"));
    //!AliAnalysisFlowTask5 *task = reinterpret_cast<AliAnalysisFlowTask5*>(gInterpreter->ExecuteMacro("AddFlowTask5.C(\"FlowTask\", \"alien:///alice/cern.ch/user/f/fernandt/weight.root\")"));

#else
    gROOT->LoadMacro("AliAnalysisFlowTask5.cxx++g");
    gROOT->LoadMacro("AddFlowTask5.C");
    AliAnalysisFlowTask5 *task = AddFlowTask5();
#endif
    ...
    if(local) {
        ...
        alienHandler->SetAdditionalLibs("AliAnalysisFlowTask5.cxx AliAnalysisFlowTask5.h");
        // alienHandler->SetAdditionalLibs("PWGCFFLOWGF.par libPWGEMCALbase.so");
        alienHandler->SetAnalysisSource("AliAnalysisFlowTask5.cxx");
